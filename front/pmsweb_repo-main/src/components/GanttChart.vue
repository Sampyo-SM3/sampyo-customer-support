<template>
  ...
  const props = defineProps({
      ...
      default: () => [
        {
          ...
          length: '32.4m (162R)',
          tasks: [
            { name: 'OUT', start: 0, duration: 8, color: '#87CEEB', value: '3.2' },
            { name: 'L.T.Z', start: 8, duration: 5, color: '#87CEEB', value: '2.1' },
            { name: 'COATING', start: 13, duration: 25, color: '#FFD700', value: '14.8' },
            { name: 'U.T.Z', start: 38, duration: 10, color: '#FFA500', value: '8.1' },
            { name: 'SAFETY', start: 48, duration: 7, color: '#191970', value: '6.3' }
          ]
        },
        {
          id: 2,
          ...
          length: '0.4m (2R)',
          tasks: [
            { name: 'OUT', start: 0, duration: 8, color: '#87CEEB', value: '0.4' }
          ]
        },
        {
          id: 3,
          name: '24-08-19 ~ 24-09-06',
          duration: 197,
          length: '37.4m (187R)',
          tasks: [
            { name: 'OUT', start: 0, duration: 6, color: '#87CEEB', value: '2.8' },
            { name: 'COATING', start: 6, duration: 20, color: '#FFD700', value: '12.5' },
            { name: 'U.T.Z', start: 26, duration: 12, color: '#FFA500', value: '9.2' },
            { name: 'SAFETY', start: 38, duration: 17, color: '#191970', value: '12.9' }
          ]
        }
      ]
    },
    config: {
      type: Object,
      default: () => ({
        margin: { top: 60, right: 30, bottom: 30, left: 50 }, // left margin 줄임
        rowHeight: 50,
        barHeight: 30,
        maxDuration: 55,
        phases: [
          { name: 'OUT', color: '#87CEEB', range: [0, 10] },
          { name: 'L.T.Z', color: '#87CEEB', range: [10, 15] },
          { name: 'COATING ZONE', color: '#90EE90', range: [15, 25] },
          { name: 'U.T.Z', color: '#FFA07A', range: [25, 35] },
          { name: 'SAFETY ZONE', color: '#90EE90', range: [35, 55] }
        ]
      })
    }
  })
