<template>
  <v-container fluid class="pr-5 pl-5 pt-7">    
    ...
    <div class="d-flex justify-center">      
      <v-btn variant="flat" color="secondary" class="custom-btn mr-2 white-text d-flex align-center" size="large" @click="goBack">
...
.label-box {
  /* 색상 변경 */
  color: #333333 !important; /* 이전: #578ADB */
  background-color: #e6eef8 !important; /* 이전: #f5f5f5 */
}
